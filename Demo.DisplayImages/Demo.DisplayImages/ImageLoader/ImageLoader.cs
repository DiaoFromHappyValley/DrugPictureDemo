...
namespace Demo.DisplayImages
{
    public sealed class ImageLoader
    {
        ...
        /// </summary>
        private int? defaultImageSize = int.Parse(ConfigurationManager.AppSettings["DrugImageDefaultSize"]);
        ...
        private void DownloadImageFile(string imageName)
        {
            ...
            {
                throw new ArgumentException("DownLoad Image Error! ImageName：{0}, Error: {1}", imageName, ex);
            }
        }
